...
sizeOfControlSample <- length(cleanControl)
sizeOfExperimentalSample <- length(cleanExperimental)
GAD_tScore <- ((meanControlDiff_GAD - meanExperimentalDiff_GAD) - 0)/sqrt((sdControlDiff_GAD)^2/sizeOfControlSample+(sdExperimentalDiff_GAD)^2/sizeOfExperimentalSample)
dfForPValue = sizeOfControlSample + sizeOfExperimentalSample - 2

GAD_pValue = pt(GAD_tScore, dfForPValue)

meanControlDiff_STAI <- mean(cleanControl$STAI_differenceCol)
meanExperimentalDiff_STAI <- mean(cleanExperimental$STAI_differenceCol)
sdControlDiff_STAI <- sd(cleanControl$STAI_differenceCol)
sdExperimentalDiff_STAI <- sd(cleanExperimental$STAI_differenceCol)
sizeOfControlSample <- length(cleanControl)
sizeOfExperimentalSample <- length(cleanExperimental)
STAI_tScore <- ((meanControlDiff_STAI - meanExperimentalDiff_STAI) - 0)/sqrt((sdControlDiff_STAI)^2/sizeOfControlSample+(sdExperimentalDiff_STAI)^2/sizeOfExperimentalSample)
dfForPValue = sizeOfControlSample + sizeOfExperimentalSample - 2

STAI_pValue = pt(STAI_tScore, dfForPValue)
...
hist(cleanControl$pretrial_GAD)
hist(cleanControl$posttrial_GAD)
hist(cleanControl$pretrial_STAI)
hist(cleanControl$posttrial_STAI)
...
hist(cleanExperimental$pretrial_GAD)
hist(cleanExperimental$posttrial_GAD)
hist(cleanExperimental$pretrial_STAI)
hist(cleanExperimental$posttrial_STAI)
```